...
public class OpenAccountInNewTabWritable implements AccountAction, TransactionSplitAction {
	 ...
	 * @param aTabbedPane The TabbedPane to open in.
	 */
	public OpenAccountInNewTabWritable(final JTabbedPane aTabbedPane, final KMyMoneyTransactionSplit aSplit) {
		this(aTabbedPane);
		setSplit(aSplit);
	}
	 ...
	 * @param aTabbedPane The TabbedPane to open in.
	 */
	public OpenAccountInNewTabWritable(final JTabbedPane aTabbedPane, final KMyMoneyAccount anAccount) {
		this(aTabbedPane);
