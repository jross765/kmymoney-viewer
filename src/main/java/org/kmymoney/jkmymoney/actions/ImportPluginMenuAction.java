 ...
 * -----------------------------------------------------------
 * major Changes:
 *  06.11.2005 - initial version, factored out of jKMyMoney
 * ...
 *
 */
...
import org.kmymoney.jkmymoney.plugin.ImporterPlugin;
...
public final class ImportPluginMenuAction implements ActionListener {
     ...
     */
    public ImportPluginMenuAction(final JKMyMoney aKMyMoney, final Extension aPlugin, final String aPluginName) {
        super();
        ...
        try {
            ...
            try {
                ...
                if (message != null && message.length() > 0) {
                    JOptionPane.showMessageDialog(myJKMyMoneyEditor, "Import OK",
