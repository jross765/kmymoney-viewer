...
import org.kmymoney.jkmymoney.actions.ImportPluginMenuAction;
import org.kmymoney.jkmymoney.actions.OpenAccountInNewTabWritable;
import org.kmymoney.jkmymoney.actions.OpenAccountInNewWindowWritable;
import org.kmymoney.jkmymoney.actions.OpenFilePluginMenuAction;
import org.kmymoney.jkmymoney.actions.SaveAsFilePluginMenuAction;
import org.kmymoney.jkmymoney.actions.ToolPluginMenuAction;
import org.kmymoney.jkmymoney.panels.WritableTransactionsPanel;
import org.kmymoney.viewer.JKMyMoneyViewer;
 ...
 * (Shall become a simple java-reimplementation of kmymoney
 * that can read and write kmymoney-files.)<br/>
 * Extended version of JKMyMoneyViewer that allows for
 * changing and writing the kmymoney-file.
 * <br/>
 *
 * @author <a href="mailto:Marcus@Wolschon.biz">Marcus Wolschon</a>
 */
public class JKMyMoney extends JKMyMoneyViewer {
	 ...
	 */
	public JKMyMoney(final PluginManager manager, final PluginDescriptor descriptor) {
		this();
	 ...
	 */
	static final Logger LOGGER = LoggerFactory.getLogger(JKMyMoney.class);

	/**
	 * The data-model.
	 */
	private KMyMoneyWritableFile model;

	/**
	 * Overridden to create  {@link KMyMoneyWritableFile}.
	 * ${@inheritDoc}.
	 */
	@Override
	protected final KMyMoneyFile createModelFromFile(final File f) throws IOException {
		return new KMyMoneyWritableFileImpl(f);
	}
	...
	//    /**
	//     * File-Menu to import other kmymoney-files
	//     * into this one.
	//     */
			...
			helpPluginReport.addActionListener(new ActionListener() {
						...
						if (reportItem.getSeverity() == IntegrityCheckReport.ReportItem.SEVERITY_ERROR) {
                            ...
                            severity = "Info: ";
													   ...
													   JOptionPane.showMessageDialog(JKMyMoney.this,
															   message.toString(),
															   "Plugins-Report",
	 ...
	 * {@inheritDoc}
	 *
	 * @see org.kmymoney.jkmymoney.JKMyMoney#getJMenuBar()
	 */
	@Override
	 ...
	 * @return our model
	 */
	public KMyMoneyWritableFile getWritableModel() {
		return model;
	}
	 ...
	 */
	@Override
	public void setModel(final KMyMoneyFile newModel) {
		if (!(newModel instanceof KMyMoneyWritableFile)) {
			throw new IllegalArgumentException("given model is not writable!");
		}
		setWritableModel((KMyMoneyWritableFile) newModel);
	}

	/**
	 * @param newModel our new model
	 */
	public void setWritableModel(final KMyMoneyWritableFile newModel) {
		if (newModel == null) {
		...
		boolean ok = false;
		KMyMoneyWritableFile oldModel = model;
		try {
			model = newModel;
	...
	protected Collection<TransactionSplitAction> getSplitActions() {
		...
		LOGGER.info("JKMyMoneyEditor has " + actionsCount + " split-actions");
